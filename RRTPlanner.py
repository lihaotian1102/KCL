...
Path planning Code with RRT (Modified from Week 28 Tutorial - RRT, by Haotian Li)
"""
...
class RRT:
    ...
    def draw_graph(self, rnd=None):
        ...
        # except IOError:
        #     i = 1
        # plt.savefig("./output/pic/pics101/" + str(i) + ".png", format='png')
...
def main(gx=6.0, gy=10.0):
    ...
    if path is None:
        ...
        with open(r'./output/performance/rrt_length100.txt', 'r') as f:
            past_dl = f.readline()
            # print(past_dl)
            if len(past_dl) != 0:
                past_dl_num = float(past_dl)
                new_dl = past_dl_num + length
                with open(r'./output/performance/rrt_length100.txt', 'w') as fw:
                    fw.write(str(new_dl))
            else:
                new_dl = length
                with open(r'./output/performance/rrt_length100.txt', 'w') as fwe:
        ...
        # list_txt(path='./output/path/path' + str(ii) + '.txt', list=list(reversed(path)))
        ...
        if show_animation:
            ...
            # plt.savefig("./output/path/path" + str(ii) + "_pic.png", format='png')
            # plt.show()
            # ii += 1
...
if __name__ == '__main__':
    ...
    with open(r'./output/performance/rrt_length100.txt') as fc:
